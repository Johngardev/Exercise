...
import com.example.demo.security.jwt.AuthEntryPointJwt; // Import for unauthorized access handler
import com.example.demo.security.jwt.AuthTokenFilter; // Import for JWT token filter
import com.example.demo.security.services.UserDetailsServiceImpl; // Import for user details service implementation
